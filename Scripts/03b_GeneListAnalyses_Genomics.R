...
Longev_Immundat.G$Elements <- str_flatten_comma(Gene2SYMBOL(unlist(stri_split_regex(str = Longev_Immundat.G$Elements, pattern = ", "))))
...
Selectiondat.G$Elements <- stri_join_list(sep = ", ", map(.x = stri_split_regex(str = Selectiondat.G$Elements, pattern = ", "), .f = Gene2SYMBOL))
...
Longevdat.G$Elements <- stri_join_list(sep = ", ", map(.x = stri_split_regex(str = Longevdat.G$Elements, pattern = ", "), .f = Gene2SYMBOL))
...
Stressdat.G$Elements <- stri_join_list(sep = ", ", map(.x = stri_split_regex(str = Stressdat.G$Elements, pattern = ", "), .f = Gene2SYMBOL))
