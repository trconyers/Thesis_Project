...
Longev_Immundat.G$Elements <- str_flatten_comma(Gene2SYMBOL(unlist(stri_extract_all_words(Longev_Immundat.G$Elements))))
...
Selectiondat.G$Elements <- stri_join_list(sep = ", ", map(.x = stri_extract_all_words(Selectiondat.G$Elements), .f = Gene2SYMBOL))
...
Longevdat.G$Elements <- stri_join_list(sep = ", ", map(.x = stri_extract_all_words(Longevdat.G$Elements), .f = Gene2SYMBOL))
...
Stressdat.G$Elements <- stri_join_list(sep = ", ", map(.x = stri_extract_all_words(Stressdat.G$Elements), .f = Gene2SYMBOL))
