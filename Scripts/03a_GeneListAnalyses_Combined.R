...
Longev_Immundat$Elements <- str_flatten_comma(Gene2SYMBOL(unlist(stri_extract_all_words(Longev_Immundat$Elements))))
...
Selectiondat$Elements <- stri_join_list(sep = ", ", map(.x = stri_extract_all_words(Selectiondat$Elements), .f = Gene2SYMBOL))
...
Longevdat$Elements <- stri_join_list(sep = ", ", map(.x = stri_extract_all_words(Longevdat$Elements), .f = Gene2SYMBOL))
...
Immundat$Elements <- stri_join_list(sep = ", ", map(.x = stri_extract_all_words(Immundat$Elements), .f = Gene2SYMBOL))
...
Stressdat$Elements <- stri_join_list(sep = ", ", map(.x = stri_extract_all_words(Stressdat$Elements), .f = Gene2SYMBOL))
