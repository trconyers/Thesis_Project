...
.my_pkgs <- c("AcidDevTools", "AcidGenerics", "AcidTest", "admisc", "assertthat", "BiocManager", "BiocVersion", "bit", "checkmate", "cli", "clipr", "collapse", "colorspace", "cpp11", "crayon", "data.table", "DBI", "fansi", "fastmap", "fastmatch", "generics", "goalie", "gtools", "pbapply", "pkgconfig", "plogr", "plyr", "prettyunits", "R.methodsS3", "R6", "RCurl", "remotes", "Rfast", "rlang", "rstudioapi", "seqinr", "statmod", "stringi", "SuperExactTest", "utf8", "BiocGenerics", "cachem", "callr", "GetoptLong", "gplots", "jamba", "lifecycle", "R.oo", "Rfast2", "tzdb", "xml2", "Biobase", "graph", "memoise", "pkgbuild", "R.utils", "S4Vectors", "vctrs", "AcidBase", "blob", "fgsea", "hms", "pillar", "pkgload", "purrr", "stringr", "tidyselect", "XVector", "installr", "pipette", "progress", "roxygen2", "RSQLite", "rtracklayer", "tibble", "AcidGenomes", "annotate", "dplyr", "GenomicFeatures", "pkgdown", "readxl", "vroom", "basejump", "devtools", "easy.utils", "readr", "mulea")
